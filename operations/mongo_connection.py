...
class MongoOperations():
    ...
    def mongo_connect(self, app):
        ...
        """
        try:
            get_mongourl = "mongodb+srv://harshitgadhiya8980:harshitgadhiya8980@cluster0.xradpzd.mongodb.net/"
    ...
    def data_added(self, app, db, coll_name, new_dict):
    ...
    def find_all_data(self, app, db, coll_name):
        """
    ...
    def find_spec_data(self, app, db, coll_name, di):
        """
    ...
    def delete_data(self, app, db, coll_name, di):
        """
    ...
    def update_mongo_data(self, app, db, coll_name, condition_dict, update_data):
        """
